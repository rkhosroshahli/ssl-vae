...
selected_labeled_indexes = random_samples(y_train, 100)
...
# vae_save_file = "VAE_MNIST_30epochs_128batch_50000train_vae_weights"
...
for i in range(100):
    ...
    for j in range(5):
        ...
        pred_y_pseudo_clf, survived_index = predict_threshold_mlp(clf, recon_data, threshold=0.99)
...
np.savez("c0_c1rep_c2_mlp_results.npz", all_train_f1_scores=all_train_f1_scores, all_test_f1_scores=all_test_f1_scores,
